...
{
    internal class OperControlUserWindowViewModel : Observable
    {
        ...
        // Конструктор
        //--------------------------------------------------------------------------------
        public OperControlUserWindowViewModel(/*RepositoryMSSQL<Jobs> repo,*/ int jobId)
        {
        ...
        public OperControlUserWindowViewModel()
        {
        }
